...
if [ ! -f /usr/sbin/slapd ]
    ...
    sed -i -e "s/DOMAIN_COMPONENT_STR_VAL/${DOMAIN_COMPONENT_STR}/g; s/DOMAIN_VAL/${DOMAIN}/g; s/HOST_VAL/${HOST}/g; s/ORGANIZATION_VAL/${ORGANIZATION}/g; s/OU_VAL/${OU}/g; s/O_VAL/${O}/g; s/USER_PASS_VAL/${USER_PASS}/g; s/USER_VAL/${USER}/g; s/HOME_DIRECTORY_VAL/${HD_DB}/g" /home/vagrant/AppsInHD.ldif
